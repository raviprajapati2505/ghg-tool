...
import MobileCombustionModal from "../projectFormModal/mobileCombustionModal";
...
export default function MobileCombustion({ pid, scid }: { pid: string; scid: string }) {
    ...
    const handleDownloadTemplate = () => {
        const templateUrl = getTemplateUrl('mobile-combustion');
        if (templateUrl) {
            const link = document.createElement('a');
            link.href = templateUrl;
            link.download = 'Mobile_Combustion_Template.xlsx';
    ...
    const handleFileUpload = async (event: React.ChangeEvent<HTMLInputElement>) => {
        ...
        try {
            const expectedFields = getTemplateFields('mobile-combustion');
            const columnMapping = getColumnMapping('mobile-combustion');
    ...
    return (
        <div className="bg-white rounded-xl shadow p-3">
            <div className="d-flex justify-content-between">
                <p className="main-title mb-3">Mobile Combustion</p>
                ...
                <table className="w-100 bg-white">
                    <thead className="text-white bg-gray-800 z-10">
                        <tr>
                            ...
                            <th className="text-start">Car Plate / ID</th>
                            <th className="text-start">Vehicle Type</th>
                        ...
                        {Array.isArray(currentPageData) &&
                            ...
                            currentPageData.map((item, index) => (
                                ...
                                >
                                    ...
                                    <td className="text-start">{item?.car_plate_id}</td>
                                    <td className="text-start">{item?.vehicle_type}</td>
                                    <td className="text-start">{item?.fuel_type}</td>
                                    <td className="text-start">{item?.consumption}</td>
