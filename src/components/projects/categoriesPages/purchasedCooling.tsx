...
import PurchasedCoolingModal from "../projectFormModal/purchasedCoolingModal";
...
export default function PurchasedCooling({ pid, scid }: { pid: string; scid: string }) {
    ...
    const handleDownloadTemplate = () => {
        const templateUrl = getTemplateUrl('purchased-cooling');
        if (templateUrl) {
            const link = document.createElement('a');
            link.href = templateUrl;
            link.download = 'Purchased_Cooling_Template.xlsx';
    ...
    const handleFileUpload = async (event: React.ChangeEvent<HTMLInputElement>) => {
        ...
        try {
            const expectedFields = getTemplateFields('purchased-cooling');
            const columnMapping = getColumnMapping('purchased-cooling');
    ...
    return (
        <div className="bg-white rounded-xl shadow p-3">
            <div className="d-flex justify-content-between">
                <p className="main-title mb-3">Purchased Cooling</p>
                ...
                <table className="w-100 bg-white">
                    <thead className="text-white bg-gray-800 z-10">
                        <tr>
                            ...
                            <th className="text-start">Cooling Supplier</th>
                            <th className="text-start">Cooling Type</th>
                            <th className="text-start">Cooling Consumption</th>
                        ...
                        {Array.isArray(currentPageData) &&
                            ...
                            currentPageData.map((item, index) => (
                                ...
                                >
                                    ...
                                    <td className="text-start">{item?.cooling_supplier}</td>
                                    <td className="text-start">{item?.cooling_type}</td>
                                    <td className="text-start">{item?.cooling_consumption}</td>
            ...
            <CategoryDetailsModal
                ...
                categoryName="Purchased Cooling"
            />
            <ReviewModal
