...
import FuelEnergyRelatedModal from "../projectFormModal/fuelEnergyRelatedModal";
...
export default function FuelEnergyRelated({ pid, scid }: { pid: string; scid: string }) {
    ...
    const handleDownloadTemplate = () => {
        const templateUrl = getTemplateUrl('fuel-energy-related');
        if (templateUrl) {
            const link = document.createElement('a');
            link.href = templateUrl;
            link.download = 'Fuel_Energy_Related_Template.xlsx';
    ...
    const handleFileUpload = async (event: React.ChangeEvent<HTMLInputElement>) => {
        ...
        try {
            const expectedFields = getTemplateFields('fuel-energy-related');
            const columnMapping = getColumnMapping('fuel-energy-related');
    ...
    const updateRow = (data: any = {}) => {
        ...
        if (selectedRowIndex !== null) {
            ...
            updatedList = [...categoryDataList, { ...data }];
        }
    ...
    return (
        <div className="bg-white rounded-xl shadow p-3">
            <div className="d-flex justify-content-between">
                <p className="main-title mb-3">Fuel & Energy Related</p>
                ...
                <table className="w-100 bg-white">
                    <thead className="text-white bg-gray-800 z-10">
                        <tr>
                            ...
                            <th className="text-start">Energy Type</th>
                            <th className="text-start">Energy Consumed</th>
                        ...
                        {Array.isArray(currentPageData) &&
                            ...
                            currentPageData.map((item, index) => (
                                ...
                                >
                                    ...
                                    <td className="text-start">{item?.energy_type}</td>
                                    <td className="text-start">{item?.energy_consumed}</td>
            ...
            <CategoryDetailsModal
                ...
                categoryName="Fuel & Energy Related"
            />
            <ReviewModal
